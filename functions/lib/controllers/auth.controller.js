...
const oauth = async (req, res) => {
    ...
    try {
        ...
        const name = decoded.name || decoded.displayName || (email === null || email === void 0 ? void 0 : email.split('@')[0]) || "User";
        ...
        if (existingUsers.length > 0) {
            ...
            const profileData = Object.assign({ providerUid, auth_provider: provider }, (picture ? { avatar: picture } : {}));
            // Insert new user
        ...
        res.status(200).json({
            ...
            data: {
                ...
                user: {
                    ...
                    avatar: ((_a = user.profile_data) === null || _a === void 0 ? void 0 : _a.avatar) || picture || null,
        ...
        res.status(200).json({
            ...
            data: {
                user: {
                    ...
                    name: user.name,
                    role: user.role,
                    avatar: ((_a = user.profile_data) === null || _a === void 0 ? void 0 : _a.avatar) || null,
