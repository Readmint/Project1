...
const getEditorProfile = async (req, res) => {
    try {
        ...
        try {
            ...
            profile.stats = Object.assign(Object.assign({}, (profile.stats || {})), { articles: reviewedCount });
        }
        catch (err) {
        ...
        res.status(500).json({ status: "error", message: "Failed to fetch profile", error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const saveEditorProfile = async (req, res) => {
    try {
        ...
        if (editorDocs.length > 0) {
            ...
            await (0, firestore_helpers_1.createDoc)('editors', Object.assign(Object.assign({ user_id: userId }, dataToSave), { created_at: new Date() }), editorId);
        }
        ...
        res.status(500).json({ status: "error", message: "Failed to save profile", error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
exports.uploadEditorResume = [
    ...
    async (req, res) => {
        try {
            ...
            res.status(500).json({ status: "error", message: "Failed to upload resume", error: err === null || err === void 0 ? void 0 : err.message });
        }
    },
];
/* ==========================================
    ...
    try {
        ...
        const results = await Promise.all(assignments.map(async (ea) => {
            ...
            return {
                ...
                assigned_date: ((_a = ea.assigned_date) === null || _a === void 0 ? void 0 : _a.toDate) ? ea.assigned_date.toDate() : ea.assigned_date,
                due_date: ((_b = ea.due_date) === null || _b === void 0 ? void 0 : _b.toDate) ? ea.due_date.toDate() : ea.due_date,
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch assignments', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
    ...
    try {
        ...
        const results = await Promise.all(assignments.map(async (ea) => {
            ...
            return {
                ...
                priority: ea.priority,
                assignment_status: ea.status,
                completed_at: ((_c = ea.updated_at) === null || _c === void 0 ? void 0 : _c.toDate) ? ea.updated_at.toDate() : ea.updated_at,
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch submitted articles', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
    ...
    try {
        ...
        try {
            ...
            versions = verRows.map((v) => {
                var _a;
                return (Object.assign(Object.assign({}, v), { note: ((_a = v.meta) === null || _a === void 0 ? void 0 : _a.notes) || null }));
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch article', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const saveDraft = async (req, res) => {
    ...
    try {
        ...
        const newMeta = Object.assign(Object.assign({}, existingMeta), { seo: { title: metaTitle || ((_a = existingMeta.seo) === null || _a === void 0 ? void 0 : _a.title) || null, description: metaDescription || ((_b = existingMeta.seo) === null || _b === void 0 ? void 0 : _b.description) || null }, editorNotes: notes || null, lastEditedBy: userId, lastEditedAt: new Date().toISOString() });
        ...
        res.status(500).json({ status: 'error', message: 'Failed to save draft', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const finalizeEditing = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to finalize editing', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const requestAuthorChanges = async (req, res) => {
    try {
        ...
        // update metadata
        const existingMeta = article.metadata || {};
        const newMeta = Object.assign(Object.assign({}, existingMeta), { lastChangeRequest: {
                by: userId,
        ...
        res.status(500).json({ status: 'error', message: 'Failed to request changes', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const approveForPublishing = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to approve', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
    ...
    try {
        ...
        const results = await Promise.all(versions.map(async (v) => {
            ...
            return {
                ...
                title: v.title,
                note: ((_a = v.meta) === null || _a === void 0 ? void 0 : _a.notes) || null, // in SQL it was JSON_EXTRACT
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch versions', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const getVersionById = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch version', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const restoreVersion = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to restore version', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const getEditorAnalytics = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch analytics', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const getCommunications = async (req, res) => {
    try {
        ...
        const results = await Promise.all(unique.map(async (c) => {
            ...
            return Object.assign(Object.assign({}, c), { sender_name: senderName, receiver_name: receiverName, created_at: c.created_at });
        }));
        // Sort
        results.sort((a, b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime());
        res.status(200).json({ status: 'success', data: results });
