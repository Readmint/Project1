...
const createPartner = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Internal server error', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const createManagedUser = async (req, res) => {
    try {
        ...
        const partnerId = requester === null || requester === void 0 ? void 0 : requester.partner_id;
        if (!partnerId) {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to create user', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const createEvent = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to create event', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const listEvents = async (req, res) => {
    try {
        ...
        if (role === 'partner') {
            partnerId = requester === null || requester === void 0 ? void 0 : requester.partner_id;
        }
        ...
        res.status(500).json({ status: 'error', message: 'Failed to list events', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const getPartnerStats = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to get stats', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const getAllPartners = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to list partners', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
