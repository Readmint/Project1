...
const submitApplication = async (req, res) => {
    try {
        ...
        try {
            ...
            logger_1.logger.error('Failed to upload CV', uploadErr);
        ...
        const applicationData = Object.assign(Object.assign({}, body), { resume_url: publicUrl, storage_path: destPath, status: 'pending', created_at: new Date() });
        ...
        logger_1.logger.error('Submit application error:', error);
