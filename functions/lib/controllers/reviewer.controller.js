    ...
    try {
        ...
        try {
            ...
            for (const attObj of attRows) {
                ...
                attachments.push(Object.assign(Object.assign({}, att), { url }));
            }
        }
        catch (e) {
        ...
        res.status(200).json({
            status: 'success',
            data: Object.assign(Object.assign({}, article), { attachments, file_url: attachments.length > 0 ? attachments[0].url : null })
        });
    }
    catch (error) {
...
const sendMessage = async (req, res) => {
    ...
    try {
        ...
        const senderName = (sender === null || sender === void 0 ? void 0 : sender.name) || 'Reviewer';
...
const getPlagiarismStatus = async (req, res) => {
    try {
        ...
        res.status(200).json({ status: 'success', data: Object.assign(Object.assign({}, row), { similarity_summary: summary }) });
    }
    catch (error) {
