...
const getPlans = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch plans', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const createPlan = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to create plan', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const updatePlan = async (req, res) => {
    try {
        ...
        await (0, firestore_helpers_1.updateDoc)('advertisement_plans', id, Object.assign(Object.assign({}, updates), { updated_at: new Date() }));
        res.status(200).json({ status: 'success', message: 'Plan updated' });
    }
    catch (err) {
        logger_1.logger.error('updatePlan error:', err);
        res.status(500).json({ status: 'error', message: 'Failed to update plan', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const deletePlan = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to delete plan', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const submitEnquiry = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to submit enquiry', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
...
const getEnquiries = async (req, res) => {
    try {
        ...
        res.status(500).json({ status: 'error', message: 'Failed to fetch enquiries', error: err === null || err === void 0 ? void 0 : err.message });
    }
};
