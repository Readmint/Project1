...
const createDoc = async (collectionName, data, docId) => {
    try {
        ...
        const finalData = Object.assign(Object.assign({}, data), { created_at: data.created_at || now, updated_at: now });
        await docRef.set(finalData);
        return Object.assign({ id: docRef.id }, finalData);
    }
    catch (error) {
...
const updateDoc = async (collectionName, docId, data) => {
    try {
        ...
        const finalData = Object.assign(Object.assign({}, data), { updated_at: firebase_admin_1.default.firestore.FieldValue.serverTimestamp() });
        await docRef.update(finalData);
        return Object.assign({ id: docId }, finalData);
    }
    catch (error) {
