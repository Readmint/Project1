...
type ReviewStatus = "In Progress" | "Pending Review" | "Completed Review" | "Needs Revision";
...
const assignedArticles: AssignedArticle[] = [
  { id: 1, title: "Blockchain Revolution in Finance", assignedDate: "Nov 14, 2025", author: "Michael Chen", dueDate: "Nov 20, 2025", priority: "High", status: "In Progress", progress: 60, image: "/images/article-thumb1.jpg" },
  { id: 2, title: "Climate Change and Technology", assignedDate: "Nov 15, 2025", author: "Emma Wilson", dueDate: "Nov 21, 2025", priority: "Medium", status: "Pending Review", progress: 0, image: "/images/article-thumb2.jpg" },
  { id: 3, title: "Future of Remote Work", assignedDate: "Nov 13, 2025", author: "David Brown", dueDate: "Nov 19, 2025", priority: "High", status: "In Progress", progress: 85, image: "/images/article-thumb3.jpg" },
  { id: 4, title: "AI Ethics and Governance", assignedDate: "Nov 16, 2025", author: "Sarah Johnson", dueDate: "Nov 22, 2025", priority: "Low", status: "Needs Revision", progress: 0, image: "/images/article-thumb4.jpg" },
  { id: 5, title: "Editorial Design Systems", assignedDate: "Nov 18, 2025", author: "Olivia Roy", dueDate: "Dec 01, 2025", priority: "Mid", status: "Completed Review", progress: 100, image: "/images/article-thumb5.jpg" },
];

const badgeStyles: Record<Priority | ReviewStatus, string> = {
...
export default function AssignedPage() {
  ...
  const [modalArticle, setModalArticle] = useState<AssignedArticle | null>(null);
    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 transition-colors">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <StatCard label="Reviewed" value={assignedArticles.filter(a => a.status === "Completed Review").length} icon={FileCheck2} />
          <StatCard label="Needs Revision" value={assignedArticles.filter(a => a.status === "Needs Revision").length} icon={AlertTriangle} />
          <StatCard label="In Progress" value={assignedArticles.filter(a => a.status === "In Progress").length} icon={BookOpen} />
        </div>
            ...
            <tbody>
              {assignedArticles
                ...
                >
                  ...
                  <td className="px-5 py-4"><span className={badgeStyles[article.priority]}>{article.priority}</span></td>
